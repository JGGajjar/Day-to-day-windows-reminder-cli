...
<p align="center">
  <img width="730" height="271" alt="n" src="https://github.com/user-attachments/assets/e3cb0d0c-69cc-48f8-8e80-e995e9f029ec" />
</p>
<p align="center">
  <img width="730" height="410" alt="cmd" src="https://github.com/user-attachments/assets/ed7c8992-8072-48fe-9c5c-874fe7e13f2c" />
</p>
...
- `SET [VB Script] file as startup applications` : [Configure Startup applications in Windows](https://support.microsoft.com/en-us/windows/experience/startup-boot/configure-startup-applications-in-windows) follow the steps & configure [VB Script] file.

> [!CAUTION]
> To finish your steps, restart your PC by saving your open work.
...
2) The Windows Command Prompt reminder : Launch and run an executable command(s)
...
> [!TIP]
> First disable reminder, update status then enable reminder.
...
> [!TIP]
> First disable reminder, update duration then enable reminder.
...
> [!TIP]
> First disable reminder, update type then enable reminder.
...
> [!TIP]
> First disable reminder, update icon image then enable reminder.
